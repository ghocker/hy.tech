...
$id= $_GET["nama"];
$lahan = query("SELECT * FROM riwayat WHERE nama_lahan = '$id'")[0];
if (isset($_POST["submit"]) ){
    if (ubahriwayat($_POST) > 0){
        echo "
            <script>
                alert('data riwayat berhasil diubah')
...
<body>
    ...
    <section class="text-center" style="padding-top:5rem;">
        <h3 class="pt-2">Ubah Data Riwayat</h3>
    </section>
    <!-- akhir jumbotron -->
    <!-- awal badan -->
    <section>
        <div class="container text-center pt-5" style="width:350px;">
            <form action="" method="post">
                ...
                <div class="row mb-3">
                    <label for="lahan">Masukkan Nama Lahan :</label>
                ...
                <div class="row mb-3">
                    <label for="hasil">Masukkan Hasil Panen :</label>
                ...
                <div class="row mb-3" style="display:inline;">
                    <a href="riwayat.php"><button type="button" class="btn btn-danger">BATAL</button></a>
