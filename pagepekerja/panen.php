        ...
        <div class="container mt-4">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <div class="text-end">
                            <form action="" method="post">
                                ...
                                <a href="hapuspanen.php?nama=<?= $row["nama_lahan"];?>" class="btn btn-danger">Hapus</a>
                                <a href="ubahpanen.php?nama=<?= $row["nama_lahan"];?>" class="btn btn-warning">Ubah</a>
                                <a href="inputriwayat.php?nama=<?= $row["nama_lahan"];?>"
            ...
            <div class="row mt-5">
                <div class="bg-success text-center" style="color:white;">
                    <h5 class="p-2">Komentar Panen</h5>
                </div>
