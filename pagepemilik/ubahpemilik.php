        ...
        <div class="container text-center pt-5" style="width:350px;">
            <form action="" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" class="text-center" name="nama" id="nama" value="<?=$pemilik["nama_pemilik"];?>">
                </div>
                <div class="row mb-3">
                    <label for="email">Masukkan Email baru</label>
                    <input type="email" class="text-center" name="email" id="email"
                        value="<?=$pemilik["email_pemilik"];?>">
                </div>
                <div class="row mb-3">
                    <label for="user">Masukkan user baru</label>
                    <input type="text" class="text-center" name="user" id="user" value="<?=$pemilik["username"];?>">
                </div>
                <div class="row mb-3">
