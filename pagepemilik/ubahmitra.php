...
$id= $_GET["nama"];
$mitra = query("SELECT * FROM mitra WHERE nama_mitra = '$id'")[0];
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item me-5">
                                <a class="nav-link active" aria-current="page" href="keuangan.php">Mitra</a>
    ...
    <section>
        <div class="container text-center pt-5" style="width:350px;">
            <form action="" method="post">
                ...
                <div class="row mb-3">
                    <label for="mitra">Masukkan Nama Mitra :</label>
                    <input type="text" class="text-center" name="mitra" id="mitra" required
                        value="<?=$mitra["nama_mitra"]?>">
                </div>
                <div class="row mb-3">
                    <label for="pemilik">Masukkan Nama Pemilik :</label>
                    <input type="text" class="text-center" name="pemilik" id="pemilik" required
                        value="<?=$mitra["nama_pemilik"]?>">
                </div>
                <div class="row mb-3">
                    <label for="contact">Masukkan Contact Mitra :</label>
                    <input type="number" class="text-center" name="contact" id="contact" required
                        value="<?=$mitra["contact"]?>">
                </div>
                <div class="row mb-3">
                    <label for="alamat">Masukkan Alamat Mitra :</label>
                    <input type="text" class="text-center" name="alamat" id="alamat" required
                        value="<?=$mitra["alamat"]?>">
                </div>
                <div class="row mb-3">
                    <label for="keterangan">Masukkan Keterangan Mitra :</label>
                    <input type="text" class="text-center" name="keterangan" id="keterangan"
                        value="<?=$mitra["keterangan"]?>">
                </div>
                <div class="row mb-3" style="display:inline;">
                    <a href="keuangan.php"><button type="button" class="btn btn-danger">BATAL</button></a>
