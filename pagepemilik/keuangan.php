...
$data_mitra = query('SELECT * FROM mitra');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container mt-4">
            ...
            <div class="row mb-3">
                <div class="card p-0">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text p-0 m-0">Nama Pemilik <span
                                style="display:inline-block; width: 30px;;"></span>:
                            &nbsp;&nbsp;<?=$row["nama_pemilik"]?>
                        </p>
                        <p class="card-text p-0 m-0">Contact <span
                                style="display:inline-block; width: 72px;"></span>:&nbsp;&nbsp;&nbsp;<?=$row["contact"]?>
                        </p>
                        <p class="card-text p-0 m-0">Alamat <span
                                style="display:inline-block; width: 77px;"></span>:&nbsp;&nbsp;&nbsp;<?=$row["alamat"]?>

                        </p>
                        <p class="card-text p-0 m-0">Keterangan <span
                                style="display:inline-block; width: 46px;"></span>:&nbsp;&nbsp;&nbsp;<?=$row["keterangan"]?>

                        </p>
                        <div class="mt-3 d-flex justify-content-end">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="">
                                <a href="hapusmitra.php?nama=<?=$row["nama_mitra"]?>" class="btn btn-danger ">Hapus</a>
                                <a href="ubahmitra.php?nama=<?=$row["nama_mitra"]?>" class="btn btn-warning ">Ubah</a>
                                <a href="transaksimitra.php?nama=<?=$row["nama_mitra"]?>"
                                    class="btn btn-success ">Daftar Transaksi</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="class pt-5 text-center">
                    <a href="tambahmitra.php" class="btn btn-success">Tambah Data Mitra</a>
                </div>
            </div>
        </div>
