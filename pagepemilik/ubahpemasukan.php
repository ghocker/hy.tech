...
$id= $_GET["nama"];
$keuangan = query("SELECT * FROM keuangan WHERE id = '$id'")[0];
        ...
        <div class="container text-center pt-5" style="width:350px;">
            <form action="" method="post">
                ...
                <div class="row mb-3" style="display:inline;">
                    <a href="pemasukan.php"><button type="button" class="btn btn-danger">BATAL</button></a>
