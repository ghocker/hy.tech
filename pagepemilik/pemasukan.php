...
$data_keuangan = query("SELECT * FROM keuangan WHERE tipe = 'pemasukan'");
$tanggal = query("SELECT DAY(tanggal), MONTH(tanggal), YEAR(tanggal), HOUR(tanggal), MINUTE(tanggal) FROM keuangan WHERE tipe = 'pemasukan'");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item me-5">
                                <a class="nav-link active" aria-current="page" href="pemasukan.php">Pemasukan</a>
        ...
        <div class="container mt-4">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <div class="mt-3 d-flex justify-content-end">
                            <form action="" method="post">
                                ...
                                <a href="hapuspemasukan.php?nama=<?=$row["id"]?>" class="btn btn-danger ">Hapus</a>
                                <a href="ubahpemasukan.php?nama=<?=$row["id"]?>" class="btn btn-warning ">Ubah</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="class pt-5 text-center">
                    <a href="tambahpemasukan.php" class="btn btn-success">Tambah Data Transaksi</a>
                </div>
            </div>
        </div>
