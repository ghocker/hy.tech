        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse me-4" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="indexpekerja.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pagepekerja/lahan.php">Lahan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pagepekerja/aktivitas.php">Aktivitas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pagepekerja/akun.php?nama=<?=$_SESSION["login"];?>">Akun</a>
                    </li>
                </ul>
            </div>
        </div>
